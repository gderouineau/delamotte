            ...
            <div id="container" class="clearfix">
                <div class="element  clearfix auto center">
                    ...
                    <article class="clearfix col2 row-auto white white-bottom auto no-side-padding">
                        ...
                        <a href="https://twitter.com/share" class="twitter-share-button" data-url="http://jordan-delamotte.com/?actu_id=<?php echo $id; ?>#filter=.actualite" data-text="<?php echo strip_tags(str_replace($tags,'',$title),'<br><br/><br />'); ?>" data-count="horizontal">Tweet</a>
                        <br /> <br />
